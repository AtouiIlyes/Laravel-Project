           ...
           <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h2>Detailles de Vendeur</h2></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
					<!-- BEGIN FORM-->

                                        <input type="hidden" name="idUtilisateur" value="{{$vendeur->id}}">
						...
						<fieldset>
							...
							<div class="alert alert-success hide">
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="nomUtilisateur" value="{{$vendeur->nom}}" type="text"  class="span6 m-wrap" disabled />
  								</div>
  							</div>
  							<div class="control-group">
  								<label class="control-label">Prenom<span class="required"></span></label>
  								<div class="controls">
  									<input name="prenomUtilisateur" value="{{$vendeur->prenom}}" type="text" placeholder="tapez votre prenom" class="span6 m-wrap" disabled />
  								</div>
  							</div>
							<div class="control-group">
  								<label class="control-label">Email<span class="required"></span></label>
  								<div class="controls">
  									<input name="email" value="{{$vendeur->email}}" type="email" placeholder="tapez votre email" class="span6 m-wrap" disabled />
  								</div>
  							</div>
                            <div class="control-group">
                                <label class="control-label">Description</label>
                                <div class="controls">
                                    <input type="text" required="required" class="span6 m-wrap" value="{{$vendeur->description}}" disabled />
                                </div>
                            </div>
							<div class="control-group">
  								<label class="control-label">Tel</label>
								<div class="controls">
  									<input type="tel" required="required" class="span6 m-wrap" value="{{$vendeur->telephone}}" disabled />
  								</div>
  							</div>
                            <div class="control-group">
                                <label class="control-label">Adresse</label>
                                <div class="controls">
                                    <input type="text" required="required" class="span6 m-wrap" value="{{$vendeur->adresse}}" disabled />
                                </div>
                            </div>
							<div class="control-group">
  								<label class="control-label">Mot de passe<span class="required"></span></label>
  								<div class="controls">
  									<input name="password" value="{{$vendeur->passwd}}" type="text"  class="span6 m-wrap" disabled />
  								</div>
  							</div>
  							<div class="control-group">
