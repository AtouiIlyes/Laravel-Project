            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span>
                     ...
                     <img src="D:/template/images/dd.png"> 
                            	...
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
											...
											<li>
											<a href="/produits">Liste Produits de Vendeur : </a>
											</li>
	                                </ul>
                            	</div>
                        	</div>
                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Liste Produits de Vendeur :</div>
                            </div>
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        @foreach ($vendeur->produits as $produit)
											...
											<tr class="odd gradeX">
                                                ...
                                                <td>{{$produit->codeabarre}}</td>
                                                <td >{{$produit->prix}}</td>
                                                <td>{{$produit->created_at}}</td>
                                                <td>{{$produit->updated_at}}</td>

                                                <td class="center">
													<button class="btn btn-primary btn-mini" onclick="window.location.href='editAdmin.html?id=${admin.idUtilisateur}'" ><i class="icon-refresh icon-white"></i>Modifier</button>
