                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Vendeurs</div>
                            </div>
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        @foreach($vendeurs as $vendeur)
                                            <tr class="odd gradeX">
                                                ...
                                                <td >
                                                    <button class="btn btn-primary btn-mini" onclick="location.href='{{action('VendeurController@detailsVendeur',['id'=>$vendeur->id])}}'" ><i class="icon-eye-close"></i>Detailles</button>

                                                </td>
                                                <td>

                                                    <button class="btn btn-primary btn-mini" onclick="location.href='{{action('VendeurController@listProduitByVendeur',['id'=>$vendeur->id])}}'" ><i class="icon-eye-close"></i>Listes des produits</button>
