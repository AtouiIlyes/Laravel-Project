           ...
           <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h2>Modifier un Client</h2></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
					<!-- BEGIN FORM-->
					...
					<!-- hidden  qui permet de stocker le champ id et en cas ou on peut modifier le champ il permet de 
						...
						<fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="date" required="required" class="span6 m-wrap" value="${admin.tel}" placeholder="tapez votre T�l" name="tel" onblur="veriftel(this)">
                                </div>
                            </div>
							<div class="control-group">
